...
class _StaffAuthGateDialogState extends State<StaffAuthGateDialog> {
  ...
  void initState() {
    super.initState();
    if (kDebugMode) {
      _usernameController.text = 'tourism_admin';
      _passwordController.text = 'Tourism@123';
    }
  }
    ...
    try {
      ...
      if (role != 'admin' && role != 'tourism') {
        setState(() {
          _loading = false;
          _errorMessage =
              'Access restricted to Resort/Tourism Staff or Administrators only. Your account role is "$role".';
        });
        return;
      }
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            const Text(
              'Sign in with your resort staff or clerk credentials to access the QR check-in scanner.',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Staff credentials: tourism_admin / Tourism@123',
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: const Text(
                        'Direct Preview Scanner (Bypass Login)',
